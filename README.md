Wordで、読みやすい文書を少ない作業量で作るには、文書を「構造化（アウトライン）」するとよい。  
「構造化された文書」とは、目次が付いているような文書のことである。  
構造化された文書のなかをみると、「章・節・項」の３階層などで大中小の「見出し」が付けてあり、「項」など末節の階層のなかに「本文」が収まっている。「章・節・項」の「見出し」を抽出して頁数を付したものが「目次」なのである。  
すなわち、Wordでの文書作成には、「本文を書く」作業と、「章立てを考える」作業がある。  
文書の全体像が自分でも見えておらず断片的なアイデアしかない場合は、忘れないうちに「本文」を書きためて、後で「章立て」をしてもよい。しかしテーマがはっきりしている場合は、まず最初に「章・節・項」の「見出し」を書き出して、項目に過不足がないか、階層の深さや並び順がおかしくないかをよく推敲して、そののちに各「項」に「本文」を書き加えていく、という手順で文章を書く。  
このような手順で文書を書くためのWordの機能が、「アウトライン表示」である。「見出し」のレベルを上げ下げしたり、「本文」ごと並び順を入れ替えたりできるので、「章立て」の作業がとてもやりやすい。  
Wordの「アウトライン」機能で、「大見出し（章）」「中見出し（節）」「小見出し（項）」と指定すると、併せて書式設定もされる。これはWordの「スタイル」という機能である。なお、初期値では「本文」というスタイルが適用されている。したがって、「大見出し」「中見出し」「小見出し」「本文」という４つの「スタイル」の書式設定を、自分好みに調整しておけば、どの文書でも、とても少ない作業量で統一感のあるデザイン（書式設定）の文書ができる。
